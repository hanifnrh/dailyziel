...
exports.createClient = function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookieStore;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                cookieStore = _a.sent();
                return [2 /*return*/, ssr_1.createServerClient(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY, {
                        cookies: {
...
exports.createAdminClient = function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookieStore;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, headers_1.cookies()];
            case 1:
                cookieStore = _a.sent();
                return [2 /*return*/, ssr_1.createServerClient(process.env.NEXT_PUBLIC_SUPABASE_URL, process.env.NEXT_PUBLIC_SUPABASE_SERVICE_ROLE, {
                        cookies: {
                            get: function (name) {
                                var _a;
                                return (_a = cookieStore.get(name)) === null || _a === void 0 ? void 0 : _a.value;
