...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="body w-full bg-white dark:bg-neutral-950"
      ref={containerRef}
    >
      <div className="w-full mx-auto">
        <h2 className="text-lg lg:text-4xl mb-4 body-bold text-black dark:text-white max-w-4xl">
          Where others see numbers, I paint stories. Where logic rules, my art flows freely.
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm lg:text-lg max-w-4xl">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col lg:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm lg:w-full">
              ...
              <h3 className="hidden lg:block text-xl lg:pl-20 lg:text-4xl font-bold text-neutral-500 dark:text-neutral-500 ">
                {item.title}
              </h3>
            </div>
