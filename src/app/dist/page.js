...
var hero_highlight_1 = require("@/components/ui/hero-highlight");
...
var vortex_1 = require("@/components/ui/vortex");
...
function Home() {
    ...
    return (React.createElement("main", null,
        React.createElement("div", { className: "flex flex-col items-center justify-center p-8 pb-20 gap-16 sm:p-20" },
            React.createElement("div", { className: "flex flex-col gap-8 items-center" },
                ...
                React.createElement("div", null,
                    React.createElement(blur_in_1["default"], { className: "text-4xl md:text-4xl lg:text-6xl title-head max-w-7xl mx-auto text-center relative z-10 py-6 lg:px-40 bg-clip-text text-transparent bg-[linear-gradient(107deg,#000000_1.10%,#000000_60.18%,#ae04ba_80.100%)] dark:bg-[linear-gradient(107deg,#ffffff_1.10%,#ffffff_60.18%,#ae04ba_105.75%)]" },
                        "Hi I'm Ziel, a",
                ...
                React.createElement(fade_text_1.FadeText, { direction: "up", className: "", framerProps: {
                    ...
                    React.createElement("div", { className: "flex gap-4 items-center flex-col sm:flex-row" },
                        React.createElement(react_1.Link, { href: "#contact" },
                        ...
                        React.createElement(animated_gradient_text_1.AnimatedGradientText, null,
                            React.createElement(react_1.Link, { className: "flex justify-center items-center text-center group", href: "https://github.com/hanifnrh", target: "_blank" },
                                "\uD83D\uDD2E",
                    ...
                    React.createElement("div", { className: "row-start-3 flex gap-6 flex-wrap items-center justify-center mt-10" },
                        React.createElement("a", { className: "flex items-center gap-2 justify-center text-base body-light tracking-normal cursor-pointer", onClick: function (e) {
                                e.preventDefault(); // Mencegah perilaku default href="#"
                                setTheme(theme === "light" ? "dark" : "light"); // Mengganti tema
                            } },
                            React.createElement("kbd", { className: "mr-1 p-1 pointer-events-none inline-flex h-fit select-none items-center gap-1 rounded border bg-purple-100 dark:bg-zinc-900 px-1.5 text-[10px] text-black dark:text-muted-foreground opacity-100 text-base body-light" },
                                React.createElement("span", { className: "text-sm" }, "\u2318"),
                                "D"),
                            "Theme"),
                        React.createElement("a", { className: "flex items-center gap-2 justify-center text-base body-light tracking-normal cursor-pointer", onClick: openMenu },
                            React.createElement("kbd", { className: "mr-1 p-1 pointer-events-none inline-flex h-fit select-none items-center gap-1 rounded border bg-purple-100 dark:bg-zinc-900 px-1.5 text-[10px] text-black dark:text-muted-foreground opacity-100 text-base body-light" },
                                React.createElement("span", { className: "text-sm" }, "\u2318"),
                                "Q"),
                            "Menu"))))),
        ...
        React.createElement("div", { className: "flex flex-col gap-10 items-center px-8 md:px-20 lg:px-40 py-20" },
            React.createElement("div", { className: "body text-lg mt-10 border-b border-black" }, "ABOUT"),
        ...
        React.createElement("div", { className: "flex flex-col gap-10 items-center px-8 md:px-20 lg:px-40 py-20" },
            React.createElement("div", { id: "crafts", className: "body text-lg mt-10 border-b border-black" }, "CRAFTS"),
            React.createElement("div", { className: "mt-10" },
                React.createElement("div", { className: "flex justify-center" },
                    React.createElement("div", { className: utils_1.cn("inline-flex items-center group rounded-full border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800") },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "flex flex-row items-center justify-center xl:justify-start gap-3 mt-5" },
                            React.createElement(rainbow_button_1.RainbowButton, null,
                                React.createElement(react_1.Link, { href: "https://www.scribd.com/document/712454157/Academiku-Prototipe-Aplikasi-untuk-Mempermudah-Siswa-dan-Pengajar-dalam-Kegiatan-Belajar-Mengajar", target: "_blank", className: "text-sm lg:text-lg text-white dark:text-black" }, "Case Study")),
                            React.createElement(ripple_button_1["default"], { rippleColor: "#ADD8E6" },
                                React.createElement(react_1.Link, { href: "https://www.figma.com/proto/4dpPY9tTTpaERumMd80OqI/Academiku?page-id=0%3A1&node-id=90-837&viewport=505%2C2553%2C0.87&t=tt3fxops6J46CJzg-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=290%3A1758&show-proto-sidebar=1", target: "_blank", className: "text-sm lg:text-lg" }, "Prototype")))),
                    React.createElement("div", null,
                        React.createElement(cardv5_1.SimpleCard_V5, null,
                            React.createElement("img", { src: "academiku.png", alt: "" }))))),
            React.createElement("div", { className: "mt-10" },
                React.createElement("div", { className: "flex justify-center" },
                    React.createElement("div", { className: utils_1.cn("inline-flex items-center group rounded-full border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800") },
                ...
                React.createElement("div", { className: "w-full grid grid-cols-1 xl:grid-cols-2 gap-10 body-light text-lg mt-10" },
                    React.createElement("div", { className: "order-1 xl:order-2" },
                        ...
                        React.createElement("div", { className: "flex flex-row items-center justify-center xl:justify-start gap-3 mt-5" },
                            React.createElement(rainbow_button_1.RainbowButton, null,
                                React.createElement(react_1.Link, { href: "https://www.scribd.com/document/712451093/Aplikasi-Jiwakita-Prototipe-Aplikasi-Kesehatan-Mental-dalam-Menghadapi-Permasalahan-Kesehatan-Mental-di-Era-Modern", target: "_blank", className: "text-sm lg:text-lg text-white dark:text-black" }, "Case Study")),
                            React.createElement(ripple_button_1["default"], { rippleColor: "#ADD8E6" },
                                React.createElement(react_1.Link, { href: "https://www.figma.com/proto/JOBOHqk9w13ZWEth8bbTTZ/jiwakita?page-id=170%3A2702&node-id=874-30730&starting-point-node-id=874%3A25000&t=doKBH4JOUhc4Ac5I-1", target: "_blank", className: "text-sm lg:text-lg" }, "Prototype")))),
                    React.createElement("div", { className: "order-2 xl:order-1" },
                        React.createElement(cardv5_1.SimpleCard_V5, null,
                            React.createElement("img", { src: "jiwakita.png", alt: "" }))))),
            React.createElement("div", { className: "mt-10" },
                React.createElement("div", { className: "flex justify-center" },
                    React.createElement("div", { className: utils_1.cn("inline-flex items-center group rounded-full border border-black/5 bg-neutral-100 text-base text-white transition-all ease-in hover:cursor-pointer hover:bg-neutral-200 dark:border-white/5 dark:bg-neutral-900 dark:hover:bg-neutral-800") },
                ...
                React.createElement("div", { className: "w-full grid grid-cols-1 xl:grid-cols-2 gap-10 body-light text-lg mt-10" },
                    React.createElement("div", null,
                        ...
                        React.createElement("div", { className: "flex flex-row items-center justify-center xl:justify-start gap-3 mt-5" },
                            React.createElement(rainbow_button_1.RainbowButton, null,
                                React.createElement(link_preview_1.LinkPreview, { url: "https://www.kerjokidul.id/", className: "text-white dark:text-black" }, "Live Preview"),
                                " "))),
                    React.createElement("div", null,
                        React.createElement(cardv5_1.SimpleCard_V5, null,
                            React.createElement("img", { src: "kerjokidul.png", alt: "" }))))),
            React.createElement("div", { className: "w-full rounded-xl h-[30rem] overflow-hidden mt-20", id: "contact" },
