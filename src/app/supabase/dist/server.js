...
var headers_1 = require("next/headers"); // This is server-side only
var createServerClientWithKey = function (key) { return __awaiter(void 0, void 0, void 0, function () {
    var cookieStore;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                cookieStore = _a.sent();
                return [2 /*return*/, ssr_1.createServerClient(process.env.NEXT_PUBLIC_SUPABASE_URL, key, {
                        cookies: {
                            get: function (name) {
                                var _a;
