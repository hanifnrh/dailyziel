    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [2 /*return*/, (React.createElement(tracing_beam_1.TracingBeam, null,
                        React.createElement("section", { id: "guestbook", className: "flex w-full max-w-sm mx-auto grow flex-col gap-y-4 md:gap-y-8 lg:gap-y-12" },
