...
function Footer() {
    ...
    return (React.createElement("div", { id: "contact", className: "flex flex-col items-center justify-center" },
        React.createElement("div", { className: "w-fit sm:rounded-full h-[40rem] overflow-hidden mt-20", "data-aos": "fade-up" },
            React.createElement("div", { className: "flex items-center flex-col justify-center px-2 md:px-10 py-4 w-full h-full" },
                React.createElement(ripple_1["default"], null),
                React.createElement(hero_highlight_1.HeroHighlight, null,
                    React.createElement(framer_motion_1.motion.h3, { initial: {
                            opacity: 0,
                            y: 20
                        }, animate: {
                            opacity: 1,
        ...
        React.createElement("div", { className: "w-full grid grid-cols-1 sm:grid-cols-3 gap-y-10 justify-between px-8 md:px-10 xl:px-20 py-20" },
            React.createElement("div", { className: "justify-center sm:justify-start items-center flex" },
                React.createElement(image_1["default"], { src: "/brands/ziel-logo.png", width: 500, height: 500, className: "h-12 w-auto navbar-logo", alt: "Picture of the author" })),
            React.createElement("div", { className: "grid sm:grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-10" },
                ...
                React.createElement(react_1.Link, { className: "flex justify-center items-center text-center group", href: "mailto:dailyziel@gmail.com", size: "md", target: "__blank" },
                    React.createElement("span", { className: "border-b border-black dark:border-white inline-flex" },
                        "Email",
                        React.createElement(go_1.GoArrowUpRight, { className: "transition-transform duration-200 transform group-hover:translate-y-[-4px]" })))),
            React.createElement("div", { className: mono_1.GeistMono.className + " text-center sm:text-end flex justify-center sm:justify-end items-center" }, "\u00A9 2025 Ziel - All Rights Reserved"))));
}
