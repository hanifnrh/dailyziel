...
var EncodedText = function () {
    ...
    return (React.createElement("div", { className: mono_1.GeistMono.className + " flex flex-col md:flex-row gap-x-5 gap-y-3 items-center" },
        ...
        React.createElement(link_1["default"], { href: "/guestbook" },
            React.createElement("p", { "data-value": "Guestbook", onMouseOver: onHover, className: "cursor-pointer uppercase text-zinc-500 hover:text-foreground" }, "GUESTBOOK")),
