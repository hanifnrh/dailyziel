...
function ResponsiveNavbar() {
    ...
    return (React.createElement("div", { className: mono_1.GeistMono.className + " fixed top-0 z-50 w-full bg-transparent backdrop-blur-lg max-w-screen-2xl" },
        React.createElement("nav", { className: "flex-wrap items-center justify-between p-4 hidden md:flex px-20" },
            React.createElement("div", { className: "left-nav flex items-center space-x-4" },
                React.createElement(react_1.Link, { href: "/", rel: "canonical", className: "flex items-center " + (currentPath === "/"
                    ...
                    React.createElement(image_1["default"], { src: "/brands/ziel-logo.png", className: "h-8 w-auto navbar-logo", alt: "Ziel Logo", width: 200, height: 200 })),
        ...
        React.createElement(react_1.Navbar, { className: "md:hidden", isMenuOpen: isMenuOpen, onMenuOpenChange: setIsMenuOpen },
            ...
            React.createElement(react_1.NavbarContent, { justify: "center" },
                React.createElement(react_1.NavbarBrand, null,
                    React.createElement(react_1.Link, { href: "/", className: "flex items-center space-x-4", rel: "canonical" },
                        React.createElement(react_1.Button, { className: "hidden sm:block" },
                            React.createElement(Clock, { locale: "en-CA" })),
                        React.createElement(image_1["default"], { src: "/brands/ziel-logo.png", className: "h-8 navbar-logo", alt: "Ziel Logo", width: 200, height: 200 })))),
            React.createElement(react_1.NavbarMenu, { className: "flex justify-center items-center text-center gap-10" }, menuItems.map(function (item, index) { return (React.createElement(react_1.NavbarMenuItem, { key: item.label + "-" + index },
                React.createElement(react_1.Link, { className: "w-full " + (currentPath === item.path
                        ...
                        : index === menuItems.length - 1
                            ? "danger"
                            : "foreground", href: item.path === "#" ? "#" : item.path, rel: "canonical", size: "lg" }, item.component || item.label))); })))));
}
