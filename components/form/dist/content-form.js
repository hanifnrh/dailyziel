...
var ContentForm = function (_a) {
    ...
    return (React.createElement("form", { className: "mt-2 flex w-full flex-col", onSubmit: handleSubmit, id: "content-form" },
        ...
        React.createElement("div", { className: "flex items-center gap-x-2" },
            ...
            React.createElement(button_1.Button, { disabled: loading, type: "submit", className: "anim aspect-square border px-2 py-2 " + (loading ? "bg-secondary/80" : "bg-secondary"), variant: "secondary" }, loading ? (React.createElement(react_icons_1.SymbolIcon, { className: "h-4 w-4 animate-spin" })) : (React.createElement(react_icons_1.ArrowRightIcon, { className: "h-4 w-4" }))))));
};
